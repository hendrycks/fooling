...
with graph.as_default():
    ...
    params = pickle.load(open("./data/r32_yuv_unscaled.pkl", "rb"), encoding='latin1')
...
try:
    history = pickle.load(open("./data/" + mode + "_r32_yuv_normal.p", "rb"))
except:
    history = {}
...
for i in range(num_to_make):
    ...
    plt.savefig('./data/yuv_r32_normal/' + mode + '/' + str(rand_int) + '_' + fooled + '.png')
    plt.close()
    ...
    pickle.dump(history, open("./data/" + mode + "_r32_yuv_normal.p", "wb"))
